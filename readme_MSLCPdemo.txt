...
The following packages were used during the development process: func-timeout (version 4.3.5), networkx (version 2.4), numpy (version 1.19.3), pandas (version 1.1.4), pulp (version 2.3.1). These packages can be installed using pip. The scripts were run with Python version 3.7.7 .

This code is a supplement to the work described in J. Zomer, N. Bešinovic, M. M. de Weerdt and R. M. P. Goverde (2020). The Maintenance Scheduling and Location Choice Problem for railway rolling stock. Not yet published. Please cite this paper when using this code.
